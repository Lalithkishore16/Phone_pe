...
if SELECT == "Home":
    ...
    col1.image(Image.open("C:\\Users\\DELL\\Downloads\\Phonepe_image2.png"),width = 700)
    with col1:
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r"C:\Users\DELL\Downloads\state.csv")
            df1.State = df2
...
if SELECT == "About":
    col1,col2 = st.columns(2)
    with col1:
        st.image(Image.open("C:\\Users\\DELL\\Downloads\\about_phonepe1.png"))
        
        st.subheader("Phonepe became a leading digital payments company")
    with col2:
        st.image(Image.open("C:\\Users\\DELL\\Downloads\\Phonepe_image2.png"),width = 300)
        st.write("---")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"Lalithkishore"}')
    mail = (f'{"Mail :"}  {"kishorekrish1661@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {
        
        "GITHUB": "https://github.com/Lalithkishore16",}
